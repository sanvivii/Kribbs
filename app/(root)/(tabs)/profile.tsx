...
function showAlert(title: string, message: string) {
    ...
    const handleHelp = () => {
        const email = "piyushagarwalvo@gmail.com";
        const subject = encodeURIComponent("Help & Support - Kribb App");
        if (Platform.OS === "web") {
            window.open(
    ...
    const handleSettings = () => {
        showAlert("Coming Soon", "Settings coming soon!");
    };

    const handleNotifications = () => {
        showAlert("Coming Soon", "Notifications coming soon!");
    };
